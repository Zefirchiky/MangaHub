...
class StorageUnit:
    ...
    def __init__(self, bytes_value: int | StorageUnit | StorageSize, name: str):
        self.bytes_value = bytes_value if isinstance(bytes_value, int) else bytes_value.bytes_value
        self.name = name
...
class StorageSize:
    ...
    def __init__(self, bytes_value: float | int | StorageSize=0):
        self.bytes_value = int(bytes_value) if not isinstance(bytes_value, StorageSize) else bytes_value.bytes_value
