...
punch_skill = Skill(
    "Punch", Damage(10, type=DamageTypes.PERCENTAGE | DamageTypes.NORMAL)
).add_damage(Damage(14, DamageTypes.PERCENTAGE))
mc = MC("John", System("Primordial Something System")).add_skill(punch_skill)

amc = (
    Antagonist("Not John")
    .add_defense(Defense(10))
    .add_defense(Defense(5, type=DamageTypes.PERCENTAGE))
)
