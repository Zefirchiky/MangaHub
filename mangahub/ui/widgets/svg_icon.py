...
class SVGIcon(QLabel):
    ...
    def __init__(self, svg_path: Path | None = None, svg_content: str | None = None, default=True, parent = None):
        super().__init__(parent)
        self.setSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)  # TODO: Will probably change pos at hover, simplify with SVGManipulator
    ...
    def set_icon(self, svg_path: Path | None = None, svg_content: str | None = None) -> 'SVGIcon':
    ...
    def set_bg_color(self, color: CM.color_type | None=None, update=False) -> 'SVGIcon':
    ...
    def set_hover(self, color: CM.color_type | None=None, size_factor: float=1.1, change_to: bool=True, update=False) -> 'SVGIcon':
    ...
    def copy(self) -> 'SVGIcon':
        icon = SVGIcon(svg_content=self.svg.get_svg_string(pretty=False)) \
        .set_size(self.width(), self.height()) \
        .set_color(self.color, update=False)
        if self.second_icon:
            icon.set_second_icon(self.second_icon).set_change_icon_on_click(self.change_icon_on_click)
        if self._hover_effect:
