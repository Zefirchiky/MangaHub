...
class SlideMenu(QFrame):
    def __init__(self, parent=None, is_vertical=True, menu_expand_button_pos=0):
        ...
        self.buttons = {}
        self.buttons_layout = QBoxLayout(
        ...
        expansion_button.setStyleSheet(
    ...
    def adjust_geometry_with_animation(
        self,
        geom1: QRect | list | tuple,
        geom2: QRect | list | tuple,
        anim_time=300,
        easing: QEasingCurve.Type = QEasingCurve.Type.InOutCubic,
        fn_at_animation=None,
        fn_after_animation=None,
    ):
