...
class LineLabel(SmoothScrollArea):
    ...
    def set_font(self, font: QFont | None=None, font_name: str="Times", font_size: int=12, font_weight: int=5):
        if font:
            self.font_ = font
        else:
    ...
    def set_selectable(self, is_selectable: bool=False):
        ...
        self.label.setTextInteractionFlags(Qt.TextInteractionFlag.TextSelectableByMouse if is_selectable else Qt.TextInteractionFlag.NoTextInteraction)
        return self
